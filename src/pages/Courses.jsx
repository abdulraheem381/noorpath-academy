    ...
    const courses = [
        {
            ...
            level: "Beginner",
            duration: "Flexible",
            desc: "The essential foundational step to reading the Quran. Designed perfectly for completely beginners, both young children and adults.",
            requirements: "None (for complete beginners)",
            goals: ["Master Arabic phonetics", "Fluent reading capability", "Understanding basic rules"],
            color: "border-blue-200",
            linkTarget: "/pricing?course=qaida",
            comingSoon: false
        },
        {
            ...
            level: "Intermediate",
            duration: "Flexible",
            desc: "Perfect your recitation by mastering the complex rules of Tajweed and characteristics of letters to recite beautifully.",
            requirements: "Qaida Completed",
            goals: ["Flawless recitation", "Deep rules understanding", "Beautiful rhythm"],
            color: "border-brand-gold/50",
            linkTarget: "/pricing?course=recitation",
            comingSoon: false
        },
        {
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    {courses.map((course, idx) => (
                        <motion.div
                            ...
                            className={`bg-white rounded-3xl p-8 md:p-10 shadow-lg border-2 ${course.color} hover:shadow-2xl transition-all relative overflow-hidden group flex flex-col`}
                        >
                            ...
                            <div className="relative z-10 flex flex-col h-full flex-grow">
                                ...
                                <div className="mb-4 inline-flex items-center bg-brand-cream px-3 py-2 rounded-lg text-sm font-semibold text-brand-navy border border-gray-100">
                                    <span className="text-gray-500 mr-2">Requirements:</span> {course.requirements}
                                </div>
                                ...
                                <Link
                                    ...
                                    className="w-full inline-flex justify-center items-center gap-2 px-8 py-4 bg-brand-navy text-white text-lg font-bold rounded-xl hover:bg-brand-green transition-colors glow-gold-hover mt-auto"
                                >
                                    Enroll Options <ChevronRight size={20} />
                                </Link>
                            </div>
                        </motion.div>
                    ))}
